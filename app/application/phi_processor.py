            ...
            messages = [
                {
                    ...
                    "content": (
                                ...
                                "4. NO agregues comillas, barras diagonales ni formato especial alrededor de palabras.\n"
                                "5. Mantén la conjugación verbal correcta según el contexto (gerundios, infinitivos, etc.).\n\n"
                                ...
                                "- Concordancia de género en adjetivos: 'muy severas' → 'muy duras' (mantener género femenino).\n"
                                "- Mantener la conjugación verbal según el contexto: 'chicos presumiendo' NO cambiar a 'chicos presumir'.\n"
                                "- Mantener la conjugación correcta en verbos compuestos: 'me embolató' → 'me extravió' (tercera persona).\n\n"
                                "NO CORRIJAS:\n"
                                ...
                                "Entrada: 'Solo hay una cosa que me pondría más berraco ahora, y eso es si me dice que me embolató las boletas de la lotería'\n"
                                "Errores: 'me embolató' → 'me extravió' (mantener tercera persona).\n"
                                "Salida: 'Solo hay una cosa que me pondría más enojado ahora, y eso es si me dice que me extravió las papeletas de la lotería'\n\n"
                                "Entrada: 'Las tareas que nos asigna la coordinadora son muy severas, pero, es mucho mejor esto que mi camello anterior'\n"
                                "Errores: 'muy severas' → 'muy duras' (mantener género femenino para concordar con 'tareas').\n"
                                "Salida: 'Las tareas que nos asigna la coordinadora son muy duras, pero, es mucho mejor esto que mi trabajo anterior'\n\n"
                                "Entrada: 'Resulta que estaba yendo al camello en bus como siempre, cuando escucho a un chico chicaneando un saco gucci que a simple vista se ve que es chimbo porque dice tucci'\n"
                                "Errores: NO agregues comillas ni formato especial a palabras como 'tucci'.\n"
                                "Salida: 'Resulta que estaba yendo al trabajo en bus como siempre, cuando escucho a un chico presumiendo un saco gucci que a simple vista se ve que es falso porque dice tucci'\n\n"
                                "Entrada: 'Anoche estaba en el centro comercial con mis papás y vimos unos chicos chicaneando sus compras'\n"
                                "Errores: Mantener el gerundio 'chicaneando' → 'presumiendo' (NO cambiar a infinitivo).\n"
                                "Salida: 'Anoche estaba en el centro comercial con mis papás y vimos unos chicos presumiendo sus compras'\n\n"
